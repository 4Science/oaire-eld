...
The [Data Correction Service](data-correction.md) requires a json file produced from a subscription that you need to setup on the [OpenAIRE Content Provider dashboard](https://provide.openaire.eu/). You can retrieve such file using the [command line tool provided by the OpenAIRE Technical Team](https://github.com/openaire/broker-cmdline-client).
